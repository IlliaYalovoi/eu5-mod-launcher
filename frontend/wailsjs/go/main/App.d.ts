...
export function CreateLauncherCategory(arg1:string):Promise<main.LauncherCategory>;
...
export function FetchWorkshopMetadataBatch(arg1:Array<string>):Promise<Record<string, steam.WorkshopItem>>;
...
export function GetConstraints():Promise<Array<graph.Constraint>>;
...
export function GetModsDirStatus():Promise<main.ModsDirStatus>;
